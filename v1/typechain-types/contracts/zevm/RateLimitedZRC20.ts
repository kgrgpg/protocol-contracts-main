...
export interface RateLimitedZRC20Interface extends utils.Interface {
  functions: {
    ...
    "maxWithdrawCountPerDay()": FunctionFragment;
    "maxWithdrawVolumePerDay()": FunctionFragment;
    "name()": FunctionFragment;
    "setMaxWithdrawCountPerDay(uint256)": FunctionFragment;
    "setMaxWithdrawVolumePerDay(uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "decimals"
      | "deposit"
      | "maxWithdrawCountPerDay"
      | "maxWithdrawVolumePerDay"
      | "name"
      | "setMaxWithdrawCountPerDay"
      | "setMaxWithdrawVolumePerDay"
      | "symbol"
      | "totalSupply"
      | "transfer"
      | "transferFrom"
  ...
  encodeFunctionData(
    functionFragment: "maxWithdrawCountPerDay",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "maxWithdrawVolumePerDay",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "name", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "setMaxWithdrawCountPerDay",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "setMaxWithdrawVolumePerDay",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
...
export interface RateLimitedZRC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RateLimitedZRC20Interface;
  ...
  functions: {
    ...
    maxWithdrawCountPerDay(overrides?: CallOverrides): Promise<[BigNumber]>;

    maxWithdrawVolumePerDay(overrides?: CallOverrides): Promise<[BigNumber]>;

    name(overrides?: CallOverrides): Promise<[string]>;

    setMaxWithdrawCountPerDay(
      _newCount: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    setMaxWithdrawVolumePerDay(
      _newVolume: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
